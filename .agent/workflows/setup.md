...
- `CLAUDE.md` dosyasındaki `Basic Calculator - Premium Temel Hesap Makinesi`, `Basic Calculator - Premium Temel Hesap Makinesi — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
